...
| -------------------------- | -------- | --------------------------- | ------------- | -------------------- |
| "Apa itu Zona Integritas?" | factual  | "Zona Integritas adalah..." | doc-001       | "Zona Integritas..." |
...
| query                         | label         | subtype        |
| ----------------------------- | ------------- | -------------- |
| "Apa itu Zona Integritas?"    | in_domain     | direct_factual |
...
| ----------- | -------------- | --------------- | ----------- | --------------- | ------------------ | --------- | --------------------------- |
| q-001       | "Apa itu WBK?" | "WBK adalah..." | 0           | "WBK adalah..." | "Wilayah Bebas..." | supported | "Context directly supports" |
