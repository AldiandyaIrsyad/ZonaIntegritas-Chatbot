...
from app.core.interfaces.infra import ParsedElement
...
def split_into_children(
    ...
    logger.debug(
        "rag.chunking.children_created", parent_id=parent.id, child_count=len(children)
    )
    return children
